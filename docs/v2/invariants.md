...
| 9 | `POST /api/workspaces/{wsId}/chats` | Create chat `{name, provider, resumeIdentity?}`; provider normalized to omo; workspace-bound identity check (invariant 21) | KEEP |
