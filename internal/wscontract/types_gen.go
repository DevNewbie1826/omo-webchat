...
func (v *DagDigest) UnmarshalJSON(data []byte) error {
	...
	extra, err := captureExtraFields(data, []string{"received_at", "running_count", "runs", "truncated"}, []string{}, []string{})
	if err != nil {
		return err
	}
	v.ExtraFields = extra
...
func (v *TaskDigest) UnmarshalJSON(data []byte) error {
	...
	extra, err := captureExtraFields(data, []string{"received_at", "running_count", "tasks", "total_count", "truncated"}, []string{}, []string{})
	if err != nil {
		return err
	}
	v.ExtraFields = extra
...
func ParseServerFrame(data []byte) (ServerFrame, error) {
	...
	if target := NewServerFrame(probe.Type); target != nil {
		...
		case "sessions.activity":
			if err := validateFrameJSON(data, validationSchema{Type: "object", Properties: map[string]validationSchema{"dagDigest": validationSchema{Type: "object", Properties: map[string]validationSchema{"received_at": validationSchema{Type: "string"}, "running_count": validationSchema{Type: "integer"}, "runs": validationSchema{Type: "array", Items: &validationSchema{Type: "object", Properties: map[string]validationSchema{"run_id": validationSchema{Type: "string"}, "running_task_ids": validationSchema{Type: "array", Items: &validationSchema{Type: "string"}}, "status": validationSchema{Type: "string"}}, Required: []string{"run_id", "status", "running_task_ids"}}}, "truncated": validationSchema{Type: "boolean"}}, Required: []string{"runs", "truncated", "running_count"}}, "durableSessionId": validationSchema{Type: "string"}, "overflow": validationSchema{Type: "boolean"}, "replacesSessionId": validationSchema{Type: "string"}, "sessionId": validationSchema{Type: "string"}, "snapshots": validationSchema{Type: "array", Items: &validationSchema{Type: "object", Properties: map[string]validationSchema{"data": validationSchema{}, "name": validationSchema{Type: "string", Enum: []string{"omo.task.updated", "omo.dag.updated"}}, "oversized": validationSchema{Type: "boolean"}}, Required: []string{"name", "oversized"}}}, "taskDigest": validationSchema{Type: "object", Properties: map[string]validationSchema{"received_at": validationSchema{Type: "string"}, "running_count": validationSchema{Type: "integer"}, "tasks": validationSchema{Type: "array", Items: &validationSchema{Type: "object", Properties: map[string]validationSchema{"raw_status": validationSchema{Type: "string"}, "status": validationSchema{Type: "string"}, "task_id": validationSchema{Type: "string"}, "updated_at": validationSchema{Type: "string"}}, Required: []string{"task_id", "status"}}}, "total_count": validationSchema{Type: "integer"}, "truncated": validationSchema{Type: "boolean"}}, Required: []string{"tasks", "truncated", "running_count", "total_count"}}, "type": validationSchema{Const: "sessions.activity"}}, Required: []string{"type", "sessionId", "durableSessionId", "snapshots", "overflow"}}); err != nil {
				return nil, err
			}
		case "approval":
