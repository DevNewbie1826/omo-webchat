...
func (v *DagDigest) UnmarshalJSON(data []byte) error {
	...
	extra, err := captureExtraFields(data, []string{"agent_running_count", "agent_total_count", "received_at", "run_running_count", "run_total_count", "running_count", "runs", "truncated"}, []string{}, []string{})
	if err != nil {
		return err
	}
	v.ExtraFields = extra
